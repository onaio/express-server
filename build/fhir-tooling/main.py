...
from temporal.shared import api_service
...
def confirm_keycloak_user(user):
    ...
    if response_email and response_email != user_email:
...
def save_image(image_source_url):
    ...
    try:
        pass
        # TODO - why do we need a product_access_token?
        # probably better to define scope of how product images will be gotten from.
