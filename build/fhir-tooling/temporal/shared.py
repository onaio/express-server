from temporal.services.fhir_keycloak_api import FhirKeycloakApi, FhirKeycloakApiOptions, ExternalAuthenticationOptions, InternalAuthenticationService, ExternalAuthenticationService, InternalAuthenticationOptions
from config import client_id, client_secret, fhir_base_url, keycloak_url, realm
...
# TODO - consider passing at and rt as args via the command line as well.
