...
export const EXPRESS_MAXIMUM_SESSION_LIVE_TIME = (process.env.EXPRESS_MAXIMUM_SESSION_LIVE_TIME || 3*60*60); // 3hrs default
export type EXPRESS_MAXIMUM_SESSION_LIVE_TIME = typeof EXPRESS_MAXIMUM_SESSION_LIVE_TIME;