...
export const EXPRESS_LOGS_FILE_PATH = '/var/log/express-server/default-errors.log';

export const EXPRESS_COMBINED_LOGS_FILE_PATH = '/var/log/express-server/default-combined.log';
