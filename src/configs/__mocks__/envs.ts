...
export const EXPRESS_LOGS_FILE_PATH = '/tmp/logs/express-server/default-errors.log';

export const EXPRESS_COMBINED_LOGS_FILE_PATH = '/tmp/logs/express-server/default-combined.log';
